...
import com.zhihuiyan.resutl_to_json.ZH_ClueNer_10_ResultToJson;
public class MainForZH_10 {
	...
	static String onnxPath = "F:\\onnx_java\\model_resource_for_clue\\clue_mode_optimized.onnx";
	...
	public static List<List<List<Entity>>> predict(String[] string_text) throws OrtException, IOException {
		...
		//预测结果
		List<List<List<Entity>>> result = ZH_ClueNer_10_ResultToJson.predictPosProcess(string_text,result_list);
