...
public class WordpieceTokenizer extends Tokenizer {
    public static final int DEFAULT_MAX_CHARACTERS_PER_WORD = 200;
    public static final String DEFAULT_UNKNOWN_TOKEN = "[UNK]";

    public final int maxCharactersPerWord;
    ...
    private Stream<String> splitToken(final String token) {
        ...
        while(start < characters.length) {
            ...
            if(!found) {
                ...
                //System.out.println(unknownToken + "\t" + start + "\t" + end);
                break;
            }
            start = end;
        }
